...
import 'package:spotter/core/models/user_model.dart'; // [아우] UserProfile 모델을 사용하기 위해 import
import 'package:spotter/features/profile_and_mypage/presentation/screens/coupon_redemption_screen.dart';
import 'package:spotter/features/stamp_and_tour/presentation/screens/find_stamps_screen.dart';
import 'package:spotter/features/stamp_and_tour/presentation/screens/ongoing_stamps_screen.dart';
import 'package:spotter/features/stamp_and_tour/presentation/screens/ongoing_tours_screen.dart';

class StampScreen extends StatefulWidget {
  // [아우] 🔥🔥🔥 MainScreen으로부터 사용자 정보를 전달받기 위한 통로를 만듭니다.
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => FindStampsScreen(
                  // [아우] 🔥🔥🔥 FindStampsScreen에 사용자 정보를 전달합니다.
                  currentUser: widget.currentUserProfile.toMap(),
                )),
              );
            },
          ),
