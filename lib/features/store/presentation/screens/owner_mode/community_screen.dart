...
import 'package:spotter/features/store/presentation/screens/owner_mode/create_owner_post_screen.dart';
...
class OwnerCommunityScreen extends StatefulWidget {
  ...
  // [아우] 🔥🔥🔥 상위 위젯으로부터 currentUser 정보를 받습니다.
  final Map<String, dynamic> currentUser;

  const OwnerCommunityScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _OwnerPostCard(
                      postData: post,
                      // [아우] 🔥🔥🔥 _OwnerPostCard에 currentUser 정보를 전달합니다.
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // [아우] CreateOwnerPostScreen에도 currentUser 정보를 전달해줍니다.
          Navigator.push(context, MaterialPageRoute(builder: (context) => CreateOwnerPostScreen(currentUser: widget.currentUser)));
        },
